...
public sealed class PlayerLedgeClimbState : PlayerState
{
    ...
    public override void Enter()
    {
        ...
        _startPosition.Set( _cornerPosition.x - (_player.GetFacingDirection() * _player.PlayerData.StartOffset.x),
                            _cornerPosition.y - _player.PlayerData.StartOffset.y);
        _stopPosition.Set(  _cornerPosition.x + (_player.GetFacingDirection() * _player.PlayerData.StopOffset.x),
    ...
    public override void LogicUpdate()
    {
        ...
        else
        {
            ...
            if (_player.GetFacingDirection() == _inputX && _isHanging && !_isClimbing)
            {
                _isClimbing = true;
